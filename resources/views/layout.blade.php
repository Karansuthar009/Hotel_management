...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="roomMaster" class="collapse @if(request()->is('admin/room*')) collapsed @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
           ...
           <!-- Department -->
            <li class="nav-item">
                ...
                <div id="departmentMaster" class="collapse @if(request()->is('admin/department*')) collapsed @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <li class="nav-item">
                ...
                <div id="staffMaster" class="collapse @if(request()->is('admin/staff*')) collapsed @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <li class="nav-item">
                ...
                <div id="bookingMaster" class="collapse @if(request()->is('admin/booking*')) collapsed @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
             ...
             <li class="nav-item">
                ...
                <div id="serviceMaster" class="collapse @if(request()->is('admin/service*')) collapsed @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
    ...
    <!-- Logout Modal-->
    <div class="modal fade" id="logoutModal" tab="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
